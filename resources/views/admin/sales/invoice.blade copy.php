...
<body>
    <table width="830" border="0" align="center" cellpadding="2" cellspacing="2" class="style3">
            ...
            <td width="454" align="right" valign="middle">
                <table width="400" border="0" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                        ...
                        <td width="255" align="left" valign="middle"> : {{ $data['sales']->invoice_no }}</td>
                    </tr>
                    <tr>
                        <td align="left" valign="middle">Invoice Date </td>
                        <td align="left" valign="middle"> : {{ date('D dS M, Y h:i A', strtotime($data['sales']->date)) }} </td>
                    </tr>
                    <tr>
                                ...
                                @foreach ($data['sales']->sales_details as $key => $value)
                                    ...
                                    <tr class="small_font">
                                        ...
                                        <td align="right" valign="middle"
                                            style="border-left:1px solid #0a0a0a; border-bottom:1px solid #0a0a0a;">
                                            {{ $data['basicInfo']->currency_symbol }} {{ number_format($value->unit_price,2) }} / {{ $value->product->unit->title }}
                                        </td>
        ...
        <tr>
            <td align="left" valign="middle"><span class="style1">Notes :</span> <span class="style3">{{ $data['sales']->note }}</span></td>
        </tr>
    </table>
</body>
