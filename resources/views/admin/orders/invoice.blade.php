...
<body>
    <div class="container">
        <div class="receipt_header">
            <h1>Receipt of Invoice <span>{{ $data['basicInfo']->title }}</span></h1>
                    ...
                    <tbody>
                        ...
                        @foreach ($data['order']->order_details as $key => $ods)
                            <tr>
                                ...
                                <td>{{ $ods->quantity }} x {{ number_format($ods->unit_price, 2) }}</td>
                                <td>{{ $data['basicInfo']->currency_symbol }}
                                    {{ number_format($subTotal = $ods->quantity * $ods->unit_price, 2) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
